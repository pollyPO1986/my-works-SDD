...
describe('PortfolioSection Component', () => {
  ...
  describe('Project Filtering and Sorting', () => {
    ...
    it('should limit displayed projects to maxFeatured', () => {
      render(<PortfolioSection items={mockProjects} maxFeatured={2} />);
  ...
  describe('Navigation Links', () => {
    ...
    it('should use custom portfolioUrl for view all link', () => {
      ...
      render(<PortfolioSection items={mockProjects} portfolioUrl={customUrl} />);
    ...
    it('should not show view all link when showViewAllLink is false', () => {
      render(<PortfolioSection items={mockProjects} showViewAllLink={false} />);

      expect(screen.queryByRole('link', { name: /查看完整作品集/i })).not.toBeInTheDocument();
    });
  ...
  describe('Callbacks', () => {
    it('should call onCardClick when card is clicked', () => {
      ...
      render(<PortfolioSection items={mockProjects} onCardClick={handleCardClick} />);
  ...
  describe('Empty State', () => {
    it('should display empty message when no featured projects', () => {
      ...
      render(<PortfolioSection items={noFeaturedProjects} emptyMessage="暫無作品項目" />);

      expect(screen.getByText('暫無作品項目')).toBeInTheDocument();
    });

    it('should use custom empty message', () => {
      render(<PortfolioSection items={[]} emptyMessage="No projects available" />);
    ...
    it('should not display project cards in empty state', () => {
      render(<PortfolioSection items={[]} emptyMessage="暫無作品項目" />);

      expect(screen.queryByRole('article')).not.toBeInTheDocument();
    });

    it('should not display view all link in empty state', () => {
      render(<PortfolioSection items={[]} showViewAllLink={true} />);
  ...
  describe('Custom className', () => {
    it('should accept and apply custom className', () => {
      const { container } = render(
        <PortfolioSection items={mockProjects} className="custom-section" />
      );
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle maxFeatured larger than featured projects count', () => {
      ...
      render(<PortfolioSection items={twoFeatured} maxFeatured={10} />);
    ...
    it('should handle maxFeatured of 1', () => {
      render(<PortfolioSection items={mockProjects} maxFeatured={1} />);
