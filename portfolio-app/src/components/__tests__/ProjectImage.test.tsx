...
describe('ProjectImage Component', () => {
  ...
  describe('Rendering', () => {
    it('should render picture element with img tag', () => {
      const { container } = render(<ProjectImage src="test.jpg" alt="Test image" />);
  ...
  describe('WebP and Responsive Images', () => {
    it('should include WebP source when srcWebp is provided', () => {
      const { container } = render(
        <ProjectImage src="project.jpg" srcWebp="project.webp" alt="Project" />
      );
    ...
    it('should set srcSet attribute on img', () => {
      render(<ProjectImage src="project.jpg" alt="Project" srcSet="300w, 600w, 900w" />);
  ...
  describe('Lazy Loading', () => {
    ...
    it('should use eager loading when eager prop is true', () => {
      render(<ProjectImage src="project.jpg" alt="Project" eager={true} />);
  ...
  describe('Image Loading Error', () => {
    it('should have onError handler for fallback', () => {
      render(<ProjectImage src="invalid.jpg" alt="Project" fallback="/images/placeholder.jpg" />);
    ...
    it('should apply aspect-video class for consistent ratio', () => {
      const { container } = render(<ProjectImage src="project.jpg" alt="Project" />);
  ...
  describe('Accessibility', () => {
    ...
    it('should support title attribute', () => {
      render(<ProjectImage src="project.jpg" alt="Project" title="My Project Title" />);
  ...
  describe('Custom className', () => {
    it('should accept and apply custom className', () => {
      const { container } = render(
        <ProjectImage src="project.jpg" alt="Project" className="custom-class" />
      );
