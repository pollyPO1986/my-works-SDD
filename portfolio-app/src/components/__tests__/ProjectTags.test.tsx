...
describe('ProjectTags Component', () => {
  ...
  describe('Style Variants', () => {
    ...
    it('should apply purple variant when specified', () => {
      const { container } = render(<ProjectTags tags={['React']} variant="purple" />);
    ...
    it('should apply green variant when specified', () => {
      const { container } = render(<ProjectTags tags={['React']} variant="green" />);
    ...
    it('should apply orange variant when specified', () => {
      const { container } = render(<ProjectTags tags={['React']} variant="orange" />);
  ...
  describe('Size Variants', () => {
    it('should apply small size classes', () => {
      const { container } = render(<ProjectTags tags={['React']} size="sm" />);
    ...
    it('should apply large size classes', () => {
      const { container } = render(<ProjectTags tags={['React']} size="lg" />);
  ...
  describe('Accessibility', () => {
    ...
    it('should have title attribute on +N for full tag list', () => {
      const { container } = render(<ProjectTags tags={mockTags} maxTags={3} />);
  ...
  describe('Custom className', () => {
    it('should accept and apply custom className', () => {
      const { container } = render(<ProjectTags tags={['React']} className="custom-class" />);
